...
\begin{figure}[H]
		\centering
			\includegraphics[width=1.0\linewidth]{Images/Integration/TicektEmissionIntegrationChart3}
...
\begin{figure}[H]
		\centering
			\includegraphics[width=1.0\linewidth]{Images/Integration/StatisticIntegrationChart1}
