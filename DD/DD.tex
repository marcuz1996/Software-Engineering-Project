...
We identified pairs of elements (components and external services) which need to be integrated together. In order of development:
\begin{enumerate}
...
%basic components utilizes DBMS API 1-2-3
...
%basic components utilizes external services 4
...
%basic components between themselves (modules between themselves) 5
...
%ticket emission needs check report and dbms api 7
...
%ticket emission needs mailing service 7
...
%autho update with dbms
\item \texttt{Data Mining components with external services}: the \texttt{Update Modules} at the client will allow unpacking and visualization of updates through the Maps and GSP services. 
%update modules with gps and maps
