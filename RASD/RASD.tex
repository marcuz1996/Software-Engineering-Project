...
\begin{table}[h]
    \begin{tabular}{|l|c|c|}
	  ...
	  A traffic violation that occured & No & World \\
	  the report of violations made by photos & Yes & World \\
	  the registration and login of any type of user & Yes & World \\
	  the selection of correct or wrong reports made by authority & Yes & World \\
	  the arrival of an officer at the site of the violation  & No & World \\
	  the confirmation or rejection of report by the officer & Yes & World \\
	  the creation of reports composed by photo, date and location & No & Machine \\
	  the creation of traffic ticket & No & Machine \\
	  the chance to see the map of violations & Yes & Machine \\
	  the data collection & No & Machine \\
	  the statistics view & Yes & Machine \\
	  sending an officer to the investigation zone & Yes & Machine \\ \hline
    \end{tabular}
\end{table}
\FloatBarrier
\subsubsection{Goals}
...
\begin {itemize}
	\item \textbf{Users}: they can access to complete SafeStreets functionalities through the smartphone application.					
		\begin{figure}[H]
			\centering
		...
		\begin{figure}[H]
			...
			\caption{Report}
		\end{figure}
	\item \textbf {Officer}: They can investigate the reports confirmed by authorities and choose to make or not the ticket.
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Main Page}]
			{\includegraphics[width=0.3\linewidth]{Images/Mockup/SchermataIniziale.png}}\quad
		...
		\end{figure}
	\item \textbf{Authority}: SafeStreets provides a Web Interface for Third Parties. Here the authorities can exploit all the functionalities at their disposal, such as the selection of wrong reports.
		\begin{figure}[H]
			\centering
			{\includegraphics[width=1\linewidth]{Images/Mockup/AuthorityWebApp.png}}
			\caption{Web App}
		\end{figure}
\end{itemize}
...
\subsection{Use case Diagram}
	\begin{figure}[H]
			\centering
			\includegraphics[width=1.2\linewidth]{Images/UseCaseDiagram.png}
	\end{figure}
