...
\begin {itemize}
	\item \textbf{Civilian}: they can access SafeStreets functionalities through the mobile application.					
		\begin{figure}[H]
			...
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/SchermataIniziale.png}}\quad
			\subfloat [][\emph {Login}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/Login.png}}\quad
			\subfloat [][\emph {Data update}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/UpdateData.png}}
			\caption{Login, Registration}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Main menu}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/user/User_Menu.png}}\quad
			\subfloat [][\emph {Statistics menu}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/user/UserStatisticsMenu.png}}
			\caption{User's Menu}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Your reports}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/user/UserStatistics_Reports.png}}\quad
			\subfloat [][\emph {HFVZ}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/Statistics_HFVZ.png}}\quad
			\subfloat [][\emph {Global Reports}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/Statistics_GlobalReports.png}}	
			\caption{User's Statistics}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Map report}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/Report.png}}\quad
			\subfloat [][\emph {Make report}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/user/ReportPhoto.png}}
			\caption{Report}
		\end{figure}
	\item \textbf {Officer}: over than civilian functionalities, they can also investigate the reports and sign automated tickets.
		\begin{figure}[H]
			...
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/SchermataIniziale.png}}\quad
			\subfloat [][\emph {Login}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/LoginOfficer.png}}\quad
			\subfloat [][\emph {Officer PIN}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/OfficerPIN.png}}
			\caption{Login, Registration, PIN}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Main menu}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/MenuOfficer.png}}\quad
			\subfloat [][\emph {Statistics menu}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/OfficerStatisticsMenu.png}}
			\caption{Officer's Menu}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Your checks}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/OfficerStatistics_YourChecks.png}}\quad
			\subfloat [][\emph {HFVZ}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/Statistics_HFVZ.png}}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Global Reports}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/Statistics_GlobalReports.png}}\quad
			\subfloat [][\emph {Repeat Offenders}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/Statistics_RepeatViolations.png}}
			\caption{Officer's Statistics}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Check violation}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/CheckViolation.png}}\quad
			\subfloat [][\emph {Under investigation}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/UnderInvestigation.png}}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfloat [][\emph {Violation confirmed}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/ViolationConfirmed.png}}\quad
			\subfloat [][\emph {Violation Rejected}]
			{\includegraphics[width=0.25\linewidth]{Images/Mockup/officer/ViolationNotConfirmed.png}}
...
\newpage
	\item \textbf{Authority}: SafeStreets provides a Web Application for law enforcement authorities where they can validate reports, request bans, toggle the automated ticket emission functionalities on or off, and most importantly add new officers.
		\begin{figure}[H]
			\centering
			{\includegraphics[width=1\linewidth]{Images/Mockup/authority/AuthorityWebApp.png}}
